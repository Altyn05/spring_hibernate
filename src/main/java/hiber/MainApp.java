...
public class MainApp {
   public static void main(String[] args) throws SQLException {
      ...
      Car mersedes = new Car("mersedes",212);
      ...
      user5.setCar(mazda);
      user6.setCar(mersedes);
      user7.setCar(BMW);
      userService.add(user5);
      userService.add(user6);
      userService.add(user7);
      System.out.println(userService.getUserByCar("mazda",626).toString());
      System.out.println(userService.getUserByCar("mersedes",212).toString());
